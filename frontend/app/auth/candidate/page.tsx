...
export default function CandidateAuthPage() {
  ...
  const login = async () => {
    ...
    try {
      ...
      // Redirect directly to candidate dashboard since this is the candidate auth page
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6 relative">
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{isSignUp ? "Create Candidate Account" : "Sign In as Candidate"}</CardTitle>
          </CardHeader>
